    ...
    public void extract_from_html()throws IOException
    {
        ...
        for (File child : directoryListing) {
            ...
            for (String part : htmlParts) {
                ...
                //Remove stop words
                ArrayList<String> allWords =  Stream.of(title.toLowerCase().split(" ")).collect(Collectors.toCollection(ArrayList<String>::new));
                allWords.removeAll(stopWords);
                title = String.join(", ", allWords);
                ...
                //Remove stop words
                ArrayList<String> allWords2 = Stream.of(header.toLowerCase().split(" ")).collect(Collectors.toCollection(ArrayList<String>::new));
                allWords2.removeAll(stopWords);
                header = String.join(", ", allWords2);

                header = header.replaceAll(", ", " ");
                System.out.println("hader:   "+ header);
                // Plain text
                String string = doc.body().text();

               // documentsBody.add(string);

                //Remove stop words
                ArrayList<String> allWords3 = Stream.of(string.toLowerCase().split(" ")).collect(Collectors.toCollection(ArrayList<String>::new));
                allWords3.removeAll(stopWords);
                string = String.join(", ", allWords3);
