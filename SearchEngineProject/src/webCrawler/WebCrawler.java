...
public class WebCrawler implements Runnable {
	...
	public static boolean wantToFindWord ;
	public static String word ;
	public static List<String> urlsFromCrawlerr;


	public WebCrawler(String urlLink,int numberOfurls, boolean wantToFindWord, String word) {
		this.urlLink = urlLink;
		this.numberOfurls=numberOfurls;
		this.wantToFindWord= wantToFindWord;
		this.word = word;
		urlsFromCrawlerr = new ArrayList<String>();
	}
	...
	public void htmlSaver(String webpage, String title) {
		try {
			...
			BufferedWriter writer =
					new BufferedWriter(new FileWriter("C:\\Users\\hi\\IdeaProjects\\18_Sarah_Mohamed_Ahmed_Lotfy\\SearchEngineProject\\html/" + title + ".html"));

			BufferedWriter writer2 =
					new BufferedWriter(new FileWriter("C:\\Users\\hi\\IdeaProjects\\18_Sarah_Mohamed_Ahmed_Lotfy\\SearchEngineProject\\html2/" + title + ".html"));
...
//        new WebCrawler().getPageLinks("https://en.wikipedia.org/");
		...
		for (int i = 0; i < numberOfThreads; ++i) {
			crawlerThreads[i] = new Thread(new WebCrawler("https://en.wikipedia.org/",numberOfurls,wantToFindWord, word ));
	...
	public void mostRelevantToWord() {
		try {
			...
			for (int j = 0; j < numberOfurls; ++j) {
				...
				urlsFromCrawlerr.add(links.toArray()[maxIndex].toString());
			}
	...
	public static List<String> returUrl()
	{
		return urlsFromCrawlerr;
	}
}
