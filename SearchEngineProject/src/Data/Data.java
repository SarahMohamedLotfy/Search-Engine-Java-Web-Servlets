...
public class Data {
    ...
    public static List<Integer>indcesFromIndexer;
    ...
    public  Data() {
        ...
        indcesFromIndexer = new ArrayList<Integer>();
    ...
    public void SetDataFromIndexer(List<String>  documentsNametemp,List<String> documentsBodyemp,
                                   ...
                                   List<String>  titletemp,List<String>  headertemp,List<String>  plaintexttemp,List<Integer> indcesFromIndexerr) {
        ...
        this.indcesFromIndexer= indcesFromIndexerr;
    }
